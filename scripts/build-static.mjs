...
const output = "dist";
const RELEASE_VERSIONS = Object.freeze({ home: "6.3.6", homeCss: "2.5.1", serviceWorker: "6.3.6", mic: "2.3.9", outputFormats: "1.0.0", promptOrchestrator: "7.4.5", automationPilot: "1.0.0", budgetInputRuntime: "1.6.0", budgetOfficialSourceRuntime: "2.1.0", documentStudio: "1.0.0", caseList: "1.0.0", searchTimeoutGuard: "1.1.0", budgetUiWatchdog: "1.2.0" });
