...
const output = "dist";
const RELEASE_VERSIONS = Object.freeze({ home: "6.4.3", homeCss: "2.5.3", serviceWorker: "6.4.4", mic: "2.3.9", outputFormats: "1.0.1", promptOrchestrator: "7.8.0", automationPilot: "1.0.0", budgetInputRuntime: "1.6.0", budgetOfficialSourceRuntime: "2.1.0", documentStudio: "1.0.0", caseList: "1.0.0", searchTimeoutGuard: "1.1.0", budgetUiWatchdog: "1.2.0" });
