...
const CASES = [
  ...
  ['ระเบียบฉบับนี้ยังมีผลใช้บังคับหรือไม่', 'HIGH', true, true],
  ['หนังสือสั่งการฉบับล่าสุดใช้กับกรณีนี้ไหม', 'HIGH', true, true],
  ['ประกาศหลักเกณฑ์ปี 2566 ใช้กับเหตุปี 2569 ได้ไหม', 'HIGH', true, true],
  ['คำพิพากษานี้ใช้เป็นแนวกับกรณีปัจจุบันได้ไหม', 'HIGH', true, true],
  ...
  ['เลขบัตรประชาชนควรใส่ในเอกสารประชาสัมพันธ์ไหม', 'LOW', false, false],
  ...
  ['พัสดุชิ้นนี้ต้องขึ้นทะเบียนไหม', 'HIGH', false, false],
  ['งบประมาณรายการนี้โอนได้ไหม', 'HIGH', true, false],
  ['มีสิทธิขอรับเงินนี้หรือไม่', 'HIGH', true, true],
  ['ผู้มีอำนาจอนุมัติเรื่องนี้คือใคร', 'HIGH', false, false],
