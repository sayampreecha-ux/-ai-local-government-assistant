...
const RELEASE = Object.freeze({ home:'6.2.0', homeCss:'2.5.0', serviceWorker:'6.2.0', budgetInputRuntime:'1.6.0', budgetOfficialSourceRuntime:'2.1.0', documentStudio:'1.0.0', caseList:'1.0.0' });
