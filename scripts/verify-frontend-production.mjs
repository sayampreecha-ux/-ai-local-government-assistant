...
const RELEASE = Object.freeze({ home:'6.4.1', homeCss:'2.5.3', serviceWorker:'6.4.2', mic:'2.3.9', budgetInputRuntime:'1.6.0', budgetOfficialSourceRuntime:'2.1.0', documentStudio:'1.0.0', caseList:'1.0.0' });
