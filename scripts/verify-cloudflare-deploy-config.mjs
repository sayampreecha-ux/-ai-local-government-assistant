...
console.log('Cloudflare deploy/privacy contract verified: self-building static assets, guarded main deploys, required secret, rate-limit handling, minimized logs, no invocation logs, traces disabled.');
