...
assert.equal(precedentBundle.casePrecedentGate.retrievalGateVersion, '1.1');
assert.equal(core.OFFICIAL_PRECEDENT_GATE_VERSION, '3.1');
assert.equal(core.OFFICIAL_AUTHORITY_RETRIEVAL_GATE_VERSION, '1.1');
assert.equal(core.PROMPT_STANDARD_VERSION, '7.9.2');
...
const currentRuleChecks = ['law', 'rule', 'regulation', 'announcement', 'primaryDirective', 'amendments', 'repealOrReplacement', 'transitionalProvisions', 'effectiveDate', 'dateContextMatched', 'laterRuleSearch', 'temporaryMeasuresAndExceptions', 'expiryAndExtensions', 'scopeOfApplication', 'priorEventsEffect'];
