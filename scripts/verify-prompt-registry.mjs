...
assert.equal(PROMPT_REGISTRY.length, 13);
...
const expectedTypes = [
  ...
  'engineering', 'public-health', 'education', 'internal-audit', 'executive', 'public-relations', 'council'
];
...
assert.equal(getPromptDefinition('GP014'), undefined);
...
assert.equal(createPromptContext('GP014', {}), undefined);
...
console.log('Prompt Registry verification passed for GP001-GP013.');
