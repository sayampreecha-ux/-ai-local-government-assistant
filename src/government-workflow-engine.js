...
export const DEEP_WORKFLOWS = Object.freeze({
  ...
  "gov.hr": [
    ...
    stage("eligibility", "คุณสมบัติ/เงื่อนไข", ["eligibilityFacts", "dataMinimizationAssessment"], ["eligibility-analysis", "hr-data-minimization-check"], { riskChecks: ["eligibility-uncertainty", "hr-data-minimization"] }),
  ...
  "gov.engineering": [
    ...
    stage("drawings-calculations", "แบบ รายการ BOQ และการคำนวณ", ["drawings", "calculations", "boqEvidence"], ["drawing-calculation-check", "boq-check"], { riskChecks: ["boq-scope-gap", "boq-quantity-mismatch"] }),
  ...
  "gov.health": [
    ...
    stage("privacy-consent", "ข้อมูลสุขภาพ ความเป็นส่วนตัว และฐานการใช้ข้อมูล", ["dataCategory", "privacyBasis", "dataMinimizationPlan"], ["health-privacy-check", "health-data-minimization-check"], { riskChecks: ["sensitive-health-data", "excessive-data"] }),
