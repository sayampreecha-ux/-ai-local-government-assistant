(() => {
  ...
  const STORAGE_KEY = 'govprompt.maintenanceFundPlans.v1';
  const CURRENT_KEY = 'govprompt.maintenanceFundPlan.current.v1';
  const MONTHS = Object.freeze([
    { key: 'oct', label: 'ต.ค.' }, { key: 'nov', label: 'พ.ย.' }, { key: 'dec', label: 'ธ.ค.' },
    { key: 'jan', label: 'ม.ค.' }, { key: 'feb', label: 'ก.พ.' }, { key: 'mar', label: 'มี.ค.' },
    { key: 'apr', label: 'เม.ย.' }, { key: 'may', label: 'พ.ค.' }, { key: 'jun', label: 'มิ.ย.' },
    { key: 'jul', label: 'ก.ค.' }, { key: 'aug', label: 'ส.ค.' }, { key: 'sep', label: 'ก.ย.' }
  ]);
  const CATEGORIES = Object.freeze([
    { id: 1, label: 'ค่ายาและเวชภัณฑ์', rule: 'drug' },
    { id: 2, label: 'ค่าวัสดุ', rule: 'procurement' },
    { id: 3, label: 'ค่าตอบแทนทางการแพทย์', rule: 'compensation' },
    { id: 4, label: 'ค่าบริการทางการแพทย์ให้แก่หน่วยบริการอื่น', rule: 'service' },
    { id: 5, label: 'ค่าครุภัณฑ์ ที่ดินและสิ่งก่อสร้าง', rule: 'capital' },
    { id: 6, label: 'ค่าใช้สอย/ค่าซ่อมแซม', rule: 'procurement' },
    { id: 7, label: 'ค่าสาธารณูปโภค', rule: 'utility' },
    { id: 8, label: 'ค่าจ้างลูกจ้างชั่วคราว', rule: 'tempstaff' },
    { id: 9, label: 'ค่าตอบแทนการปฏิบัติงานนอกเวลาราชการ', rule: 'compensation' },
    { id: 10, label: 'ค่าเดินทางไปราชการ/ค่าเข้ารับการฝึกอบรม', rule: 'travel' },
    { id: 11, label: 'ค่าใช้จ่ายอื่นที่จำเป็นที่เกี่ยวข้องกับการสาธารณสุข', rule: 'other' }
  ]);
  const STATUS = Object.freeze([
    ['draft', 'ร่าง'], ['screening', 'รอกลั่นกรอง'], ['committee', 'ผ่านคณะกรรมการ'],
