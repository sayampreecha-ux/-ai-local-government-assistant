(() => {
  ...
  const OUTPUTS = Object.freeze({
    ...
    analysis: Object.freeze({ label: 'บทวิเคราะห์', format: 'analysis', instructions: Object.freeze([
      ...
      'ถ้าเป็นการเงินหรือเบิกจ่าย ให้ขึ้นต้นด้วย “เบิกได้ / เบิกไม่ได้ / มีเงื่อนไข” ตามหลักฐาน แล้วสรุปฐานอำนาจ เงื่อนไข เอกสารประกอบ และจุดที่ต้องอนุมัติหรือใช้ดุลพินิจ',
      'ถ้าเป็นข้อกฎหมาย ให้ขึ้นต้นด้วย “ทำได้ / ทำไม่ได้ / ยังฟันธงไม่ได้” ตามหลักฐาน แล้วสรุปฐานอำนาจ สถานะฉบับล่าสุด เงื่อนไข และความเสี่ยง',
