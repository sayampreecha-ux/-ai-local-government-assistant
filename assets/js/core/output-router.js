(() => {
  ...
  const RULES = Object.freeze([
    ...
    { id: 'official_document', score: 107, patterns: [/^(?:ช่วย)?\s*(?:ร่าง|ทำ|เขียน|จัดทำ)\s*(?:หนังสือ|บันทึกข้อความ|บันทึก|คำสั่ง|ประกาศ)/] },
    { id: 'project', score: 106, patterns: [/^(?:ช่วย)?\s*(?:ร่าง|เขียน|ทำ|จัดทำ)\s*โครงการ/] },
