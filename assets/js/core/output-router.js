(() => {
  ...
  const RULES = Object.freeze([
    ...
    { id: 'official_document', score: 99, patterns: [/^(?:ช่วย)?(?:ร่าง|ทำ|เขียน|จัดทำ)\s*(?:หนังสือ|บันทึกข้อความ|บันทึก|คำสั่ง|ประกาศ)/, /(?:ร่าง|ทำ|เขียน|จัดทำ).{0,20}(?:หนังสือ|บันทึกข้อความ|บันทึก|คำสั่ง|ประกาศ).{0,45}ประชาสัมพันธ์/] },
    ...
    { id: 'table', score: 97, patterns: [/เป็นตาราง/, /ทำตาราง/, /จัดตาราง/, /สกัด.{0,18}ตาราง/] },
