(() => {
  ...
  function createToolRoutingPlan({ question, attachments = [] } = {}) {
    ...
    if (needsCurrentWeb || needsPrimarySource) {
      ...
      instructions.push('ให้ AI ที่กำลังตอบใช้ความสามารถค้นเว็บสดของบัญชีหรือแพลตฟอร์มของผู้ใช้เองเมื่อจำเป็น โดยยึดแหล่งราชการ/ต้นฉบับก่อน ตรวจสถานะฉบับล่าสุด ระบุหน่วยงานผู้ออก วันที่ และแหล่งอ้างอิง และห้ามฟันธงจากข้อมูลเก่าหรือแหล่งสรุปเพียงอย่างเดียว');
