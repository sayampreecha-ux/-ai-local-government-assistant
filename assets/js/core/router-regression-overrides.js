(() => {
  ...
  const RULES = Object.freeze([
    ...
    Object.freeze({ moduleId: 'GP012', patterns: Object.freeze([
      /(?:ทำ|สร้าง|ร่าง|เขียน|ออกแบบ).{0,20}(?:วิดีโอ|วีดีโอ|คลิป|video).{0,45}(?:ประชาสัมพันธ์|แนะนำองค์กร|แนะนำหน่วยงาน|องค์กร|หน่วยงาน)?/i,
      /(?:วิดีโอ|วีดีโอ|คลิป|video).{0,35}(?:ประชาสัมพันธ์|แนะนำองค์กร|แนะนำหน่วยงาน|องค์กร|หน่วยงาน)/i,
