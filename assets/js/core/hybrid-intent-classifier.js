(() => {
  ...
  const TRAINING = Object.freeze({
    ...
    GP003: Object.freeze([
      'จัดซื้อคอมพิวเตอร์', 'ซื้อครุภัณฑ์', 'จัดจ้างผู้รับเหมา', 'จ้างที่ปรึกษา', 'ตรวจ TOR',
    ...
    GP004: Object.freeze([
      'เขียนโครงการ', 'จัดทำแผนพัฒนาท้องถิ่น', 'จัดทำงบประมาณ', 'โอนงบประมาณ', 'แก้ไขแผนพัฒนา',
    ...
    GP005: Object.freeze([
      ...
      'เบิกค่าอาหาร', 'รถเสียระหว่างไปราชการ', 'เงินยืมไปราชการ', 'ฎีกาเบิกจ่าย', 'จ่ายเงินได้ไหม'
    ]),
    GP006: Object.freeze([
    ...
    GP009: Object.freeze([
      ...
      'การศึกษาท้องถิ่น', 'ทุนการศึกษา', 'นักเรียน', 'ครู', 'เด็กปฐมวัย', 'อาหารกลางวันโรงเรียน'
    ]),
    GP010: Object.freeze([
    ...
    GP011: Object.freeze([
      ...
      'กล่าวต้อนรับคณะศึกษาดูงาน', 'คำกล่าววันเด็ก', 'สุนทรพจน์', 'โอวาท', 'สรุปผู้บริหาร',
      'ข้อสั่งการผู้บริหาร', 'นโยบายผู้บริหาร'
    ]),
    GP012: Object.freeze([
      'ทำข่าวประชาสัมพันธ์', 'ทำโพสต์เฟซบุ๊ก', 'ทำอินโฟกราฟิก', 'ทำอินโฟสรุปกฎหมาย', 'เขียนแคปชัน',
  ...
  const PROCESS_RULES = Object.freeze([
    ...
    Object.freeze({ moduleId: 'GP012', confidence: 0.99, patterns: Object.freeze([
    ...
    Object.freeze({ moduleId: 'GP003', confidence: 0.99, patterns: Object.freeze([
      ...
      /(?:^|\s)(?:ซื้อ|จ้าง|เช่า|จัดหา).{0,30}(?:ครุภัณฑ์|วัสดุ|อุปกรณ์|คอม|คอมพิวเตอร์|โน้ตบุ๊ก|เครื่องพิมพ์|รถ|อาหาร|ผู้รับเหมา|ที่ปรึกษา|บริการ)/,
      /(?:จ้างที่ปรึกษา|จ้างเหมาบริการ|จ้างผู้รับเหมา)/
    ]) }),
  ...
  const SUBJECT_RULES = Object.freeze([
    ...
    Object.freeze({ moduleId: 'GP004', confidence: 0.955, patterns: Object.freeze([
      ...
      /(?:โอนงบประมาณ|งบกลาง|งบลงทุน|งบดำเนินงาน|ข้อบัญญัติงบประมาณ|ตัวชี้วัด|แผนพัฒนา)/
    ]) }),
  ...
  function inferSecondary(source, primaryModule) {
    ...
    add('GP003', /พัสดุ|จัดซื้อ|จัดจ้าง|tor|ครุภัณฑ์|วัสดุ/i);
  ...
  function classifyIntent(request) {
    ...
    if (top && top.score >= 0.34 && margin >= 0.035) {
    ...
    return Object.freeze({ moduleId: 'GP011', confidence: 0.40, reason: 'general-government-fallback', semantic: Object.freeze({ score: top?.score || 0, margin, example: top?.bestExample || '', ranking: ranking.slice(0, 3) }), secondary: inferSecondary(source, 'GP011') });
  }
