(() => {
  ...
  const definitions = [
    ...
    ['GP004', 'planning-budget', ['gp004', 'plan', 'project', 'budget', 'แผน', 'โครงการ', 'งบประมาณ', 'โอนงบ', 'เงินสำรอง', 'ตัวชี้วัด', 'kpi']],
    ['GP005', 'finance', ['gp005', 'finance', 'reimbursement', 'travel expense', 'การเงิน', 'เบิกจ่าย', 'ค่าเดินทาง', 'ค่าเช่าบ้าน', 'ฎีกา']],
    ['GP006', 'human-resources', ['gp006', 'human resources', 'hr', 'บุคคล', 'แต่งตั้ง', 'เลื่อนระดับ', 'โอนย้าย', 'วินัย', 'เกษียณ', 'สอบแข่งขัน']],
    ['GP007', 'engineering', ['gp007', 'engineering', 'construction', 'งานช่าง', 'วิศวกรรม', 'ก่อสร้าง', 'ถนน', 'แบบแปลน', 'ผู้ควบคุมงาน']],
    ['GP008', 'public-health', ['gp008', 'public health', 'health', 'สาธารณสุข', 'รพ.สต.', 'รพสต', 'เงินบำรุง', 'บริการสุขภาพ']],
    ['GP009', 'education', ['gp009', 'education', 'การศึกษา', 'โรงเรียน', 'ครู', 'นักเรียน', 'ศูนย์พัฒนาเด็กเล็ก']],
    ['GP010', 'internal-audit', ['gp010', 'internal audit', 'ตรวจสอบภายใน', 'ควบคุมภายใน', 'ปค.4', 'ปค.5', 'ปค.6', 'ความเสี่ยงองค์กร']],
    ['GP011', 'executive', ['gp011', 'executive', 'ผู้บริหาร', 'นายก', 'ปลัด', 'นโยบาย', 'ข้อสั่งการ', 'สรุปผู้บริหาร']],
    ['GP012', 'public-relations', ['gp012', 'public relations', 'press release', 'ประชาสัมพันธ์', 'ข่าว', 'facebook', 'infographic', 'โพสต์']],
    ['GP013', 'council', ['gp013', 'council', 'quorum', 'motion', 'resolution', 'สภาท้องถิ่น', 'ญัตติ', 'องค์ประชุม', 'มติสภา', 'ข้อบัญญัติ', 'สมัยประชุม']]
  ];
