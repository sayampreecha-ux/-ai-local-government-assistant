...
const QUICK_ACTIONS = Object.freeze({
  ...
  'ทำใหม่': 'สร้างแนวทางภาพใหม่จากภาพที่ผู้ใช้จะนำไปแนบใน AI ปลายทาง โดยคงบุคคล เครื่องแบบ โลโก้ และข้อเท็จจริงทั้งหมด',
...
export function buildCreativeImagePrompt({ request = '', iteration = '' } = {}) {
  ...
  const prompt = [
    ...
    '',
    'วิธีใช้',
    '- ผู้ใช้จะนำคำสั่งนี้ไปใช้ใน AI ที่รองรับการสร้าง/แก้ไขภาพ',
    '- หากมีภาพต้นฉบับ ผู้ใช้จะแนบภาพใน AI ปลายทางโดยตรง ไม่ได้แนบผ่าน GovPrompt',
    '- ถ้ามีภาพแนบ ให้ใช้ภาพนั้นเป็นหลักฐานของบุคคล เครื่องแบบ โลโก้ และองค์ประกอบสำคัญ',
    '',
    ...
    '- ถ้ามีภาพต้นฉบับ ให้รักษาใบหน้า รูปลักษณ์บุคคล เครื่องแบบ ตราสัญลักษณ์ โลโก้ และองค์ประกอบสำคัญ ห้ามเปลี่ยนจนผิดบุคคลหรือผิดข้อเท็จจริง',
    ...
    '- หลีกเลี่ยงการ render ภาษาไทยเป็นส่วนถาวรของ visual หากระบบสามารถแยก text layer ได้',
    ...
    '',
    'ผลลัพธ์ที่ต้องการ',
    '- สร้างหรือแก้ไขภาพจริงเป็นผลลัพธ์หลัก ไม่ต้องตอบกลับด้วย Prompt ซ้ำ',
...
export function executeImageWorkflow({ request, iteration = '' } = {}) {
  const bundle = buildCreativeImagePrompt({ request, iteration });
  return Object.freeze({ mode: 'prompt-only', bundle });
}
