(() => {
  ...
  const REDACTION_RULES = Object.freeze([
    ...
    { label: 'ชื่อ-นามสกุล', pattern: /(?:(?:ชื่อ-?นามสกุล|ชื่อผู้ป่วย|ชื่อเจ้าของบัญชี)\s*[:：-]?\s*[ก-๙A-Za-z.'’-]+(?:\s+[ก-๙A-Za-z.'’-]+){0,3}|ชื่อ\s*[:：-]\s*[ก-๙A-Za-z.'’-]+(?:\s+[ก-๙A-Za-z.'’-]+){0,3}|ชื่อ\s+(?:นาย|นางสาว|นาง|ด\.ช\.|ด\.ญ\.|เด็กชาย|เด็กหญิง)\s*[ก-๙A-Za-z.'’-]+(?:\s+[ก-๙A-Za-z.'’-]+){0,2})/gi, replacement: ' ชื่อ [ปกปิด] ' },
    { label: 'รหัสผู้ป่วย/HN/AN', pattern: /(?:\bHN\b|\bAN\b|เลขผู้ป่วย|รหัสผู้ป่วย)\s*[:：#-]?\s*[A-Za-z0-9/-]{3,30}/gi, replacement: ' รหัสผู้ป่วย [ปกปิด] ' },
    { label: 'วันเดือนปีเกิด', pattern: /(?:วันเกิด(?!เหตุ|สิทธิ|หน้าที่|ข้อเท็จจริง|ความรับผิด)|วันเดือนปีเกิด|เกิดวันที่)\s*[:：-]?\s*[^,;\n]{3,40}/gi, replacement: ' วันเกิด [ปกปิด] ' },
  ...
  const SENSITIVE_CONTEXT_RULES = Object.freeze([
    { label: 'ข้อมูลสุขภาพ/ความพิการ', pattern: /(?:ข้อมูลสุขภาพ|ผลตรวจ|ผลเลือด|ผลเอกซเรย์|ผล(?:MRI|CT)|การวินิจฉัย|ประวัติการรักษา|โรคประจำตัว|ชื่อโรค|อาการป่วย|ยาที่ใช้|ยาประจำ|ชื่อยา|ขนาดยา|รายการยา|ยารักษา|ยาแก้|ยาฉีด|ยาเม็ด|รับประทานยา|ใช้ยา|แพ้ยา|(?:^|[\s:：,;()[\]{}])ยา(?=$|[\s:：,;()[\]{}])|หมู่เลือด|กรุ๊ปเลือด|ความพิการ|ผู้พิการ|สุขภาพจิต|จิตเวช)/i },
