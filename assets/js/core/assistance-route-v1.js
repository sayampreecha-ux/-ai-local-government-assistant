(() => {
  ...
  const AP = Object.freeze({
    ...
    AP007: { label: 'ตรวจเอกสารและหลักฐาน', keywords: [/หลักฐาน/, /เอกสาร/, /ภาพถ่าย/, /ทะเบียนบ้าน/, /แบบคำขอ/, /ใบรับรอง/, /เอกสาร.*ช่วยเหลือ/, /หลักฐาน.*ช่วยเหลือ/] },
    ...
    AP010: { label: 'จัดทำ Checklist เจ้าหน้าที่', keywords: [/checklist/, /เช็กลิสต์/, /รายการตรวจ/, /ขั้นตอนเจ้าหน้าที่/, /checklist.*เอกสาร/, /รายการ.*ตรวจ.*ช่วยเหลือ/] },
