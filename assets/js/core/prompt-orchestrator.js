(() => {
  ...
  const DELIVERABLES = Object.freeze([
    ['official-document', /(?:หนังสือราชการ|บันทึกข้อความ|หนังสือภายนอก|หนังสือภายใน|คำสั่ง|ประกาศ|mou|(?:ร่าง|ทำ|เขียน|จัดทำ)\s*หนังสือ)/i],
  ...
  const DISCIPLINES = Object.freeze([
    ['records', /(?:หนังสือราชการ|บันทึกข้อความ|สารบรรณ|รับส่งหนังสือ|(?:ร่าง|ทำ|เขียน|จัดทำ)\s*หนังสือ)/i],
    ...
    ['executive', /(?:ผู้บริหาร|สรุปผู้บริหาร|briefing|คำกล่าว|วิสัยทัศน์)/i],
