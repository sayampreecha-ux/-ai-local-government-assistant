(() => {
  ...
  function buildOutputFormatPresetBlock(id) {
    ...
    return [
      ...
      '',
      'ข้อกำกับการนำเสนอสำหรับงานราชการ',
      ...
      '- จัดผลลัพธ์ให้อ่านง่ายและเรียงสาระสำคัญก่อนรายละเอียด แต่ห้ามตัดข้อกำหนดหรือสาระบังคับของชิ้นงานหลักเพื่อให้สั้นลง',
      ...
      '- ถ้าผู้ใช้ไม่ได้ขอสื่อภาพ/อินโฟกราฟิก ไม่ต้องเสนอการจัดวางภาพ สี ไอคอน หรือองค์ประกอบกราฟิกเพิ่มเอง',
