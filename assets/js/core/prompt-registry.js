(() => {
  ...
  const PROMPT_QUALITY_STANDARD = deepFreeze({
    ...
    universal: [
      ...
      'เรื่องกฎหมาย สิทธิ อำนาจ การเงิน พัสดุ บุคคล และข้อมูลที่เปลี่ยนตามเวลา ต้องให้ AI ที่กำลังตอบใช้ความสามารถค้นเว็บสดของบัญชีหรือแพลตฟอร์มผู้ใช้เอง เพื่อตรวจแหล่งราชการ/ต้นฉบับและสถานะฉบับล่าสุดก่อนฟันธง',
      'ถ้า AI ฝั่งผู้ใช้ไม่มีความสามารถค้นเว็บ หรือยังยืนยันหลักฐานปัจจุบันไม่ได้ ต้องระบุว่า “ยังไม่ยืนยันว่าเป็นข้อมูลปัจจุบันล่าสุด — ยังไม่ควรฟันธง” และห้ามทำเหมือนค้นสดสำเร็จ',
