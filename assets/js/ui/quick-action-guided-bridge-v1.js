(() => {
  ...
  const WORK_CATALOG = Object.freeze([
    ...
    Object.freeze({
      id: 'pr', title: 'ประชาสัมพันธ์และสื่อสาร', keywords: 'PR ประชาสัมพันธ์ ข่าว โพสต์ Facebook อินโฟกราฟิก คำกล่าว สคริปต์',
      tasks: Object.freeze([
        ...
        Object.freeze({ label: 'ร่างสคริปต์ / คำกล่าว', prompt: 'ช่วยร่างสคริปต์หรือคำกล่าวให้เหมาะกับผู้พูด ผู้ฟัง และโอกาส' })
      ])
    }),
    Object.freeze({
